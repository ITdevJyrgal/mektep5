            ...
            <div className="container">
                ...
                <div className="services__general">
                    <div className="services__general--contact">
                        <a href="mailto:chonalaybokonbaev@gmail"><span style={{fontSize: media(15,20)}}><i className="fa-solid fa-envelope"/> chonalaybokonbaev@gmail</span></a>
                        <a href="https://www.instagram.com/bokonbaevmektebi/"><span style={{fontSize: media(15,20)}}><i className="fa-brands fa-instagram"/> bokonbaevmektebi</span></a>
                        {/*<a href="#"><span style={{fontSize: media(15,20)}}><i className="fa-brands fa-facebook-f"/> balancha_mektebi</span></a>*/}
                        <a href="tel:0779-16-19-75"><span style={{fontSize: media(15,20)}}><i className="fa-solid fa-phone"/> 0779-16-19-75</span></a>
